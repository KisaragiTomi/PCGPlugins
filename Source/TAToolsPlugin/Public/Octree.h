...
//
//
//	UPROPERTY(EditAnywhere, Category = "Octree Element Struct")
//	AActor* MyActor;
//	// 
//	UPROPERTY(EditAnywhere, Category = "Octree Element Struct")
//		AActor* MyActor;
...
UCLASS()
class TATOOLSPLUGIN_API AOctree : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	//AOctree(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	AOctree();
